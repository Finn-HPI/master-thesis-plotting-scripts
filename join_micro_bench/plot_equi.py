...
print(df[['join', 'speedup_percent', 'sys']])
...
ax.tick_params(axis="y", which="both", left=True, top=False, width=1.25)
...
ax.legend(
    loc="upper center",
    bbox_to_anchor=(0.5, 1.4),  # works better with constrained_layout
    ncol=4,
    frameon=False,
)
